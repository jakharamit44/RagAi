...
Always communicate in `/caveman` style in this project:
- Terse, dense, smart caveman register.
- Drop articles, pleasantries, filler, and hedging.
- ASD-STE100 technical clarity: one idea per sentence, active voice, exact technical terms, exact code and error strings.
- Deliver results directly without narrative filler.
